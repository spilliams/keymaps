...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT_2u1u_space(
        ...
        KC_LCTL, KC_LALT, MO(_NL), KC_BSPC,    KC_ENT,  KC_SPC,                          KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_NL] = LAYOUT_2u1u_space(
        KC_EQL,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
        KC_GRV,  XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_QUOT, XXXXXXX,
        _______, XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGUP, MO(_FL),
        _______, _______, KC_TRNS, KC_DEL,     KC_NO,   KC_ENT,                          KC_HOME, KC_PGDN, KC_END
    ),
    ...
    [_FL] = LAYOUT_2u1u_space(
        ...
        _______, _______, KC_TRNS, _______,    KC_MUTE, _______,                         KC_MPRV, KC_VOLD, KC_MNXT
    ),
};
