...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, MO(_NL), KC_LALT,    KC_BSPC,     KC_SPC,    MO(_FL), MO(_KL), MO(_OL), MO(_SL)
    ),
    ...
    [_NL] = LAYOUT(
        ...
        _______, _______, KC_TRNS, _______,    _______,      _______,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    ...
    [_SL] = LAYOUT(
        ...
        _______, _______, KC_TRNS, _______,    KC_DEL,      _______,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    ...
    // OS layer
    [_OL] = LAYOUT(
        KC_SLEP, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_MPLY, _______, _______, _______,
    ...
    [_KL] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_TRNS,
        RESET,   _______, KC_TRNS, _______,    _______,     _______,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    )
