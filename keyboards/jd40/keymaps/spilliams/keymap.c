...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NL] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL,  _______, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    ...
    [_FL] = LAYOUT(
        ...
        _______, _______, _______, KC_TRNS, KC_DEL,  _______, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
