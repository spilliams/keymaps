...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
    *   | Ctrl |(SYMB)|LMouse|  Gui |  Alt |                                       | Left | Down |  Up  | Right|      |
    *   `----------------------------------'                                       `----------------------------------'
    *                                        ,-------------.       ,-------------.
    *                                        |      |      |       |      |      |
    *                                 ,------|------|------|       |------+------+------.
    ...
    * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
    * | LShift |   Z  |   X  |   C  |   V  |   B  | LMous|           |RMous |   N  |   M  |   ,  |   .  |   /  | RShift |
    * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
    ...
    */
    ...
    KC_GRV,  KC_Q,     KC_W,  KC_E,    KC_R,    KC_T,    TG(GAME),  KC_BTN3,  KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,     KC_BSLS,
