 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCtl | LAlt | SYMB | Del  | /  BSpc /       \ Spc  \  | Ret  | SYMB | GUI  | RCtl |
 *            `------------------------------------'         '------''----------------------------'
 */
[BASE] = LAYOUT( \
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,  KC_MUTE, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
                KC_LCTL,  MO(SYMB),  KC_LALT, KC_DEL,  KC_BSPC,    KC_SPC,   KC_ENT, MO(SYMB), KC_LGUI,  KC_RCTL \
),
...
[SYMB] = LAYOUT( \
    ...
    KC_TRNS, KC_NO,  KC_NO,  KC_LBRC, KC_RBRC,  KC_NO, KC_MPLY,   KC_MUTE,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_TRNS, \
               KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS,  KC_TRNS, MO(FUNC), KC_TRNS, KC_TRNS \
),

/* Function layer
 * Encoders are the same as Symbol
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[FUNC] = LAYOUT( \
    ...
    KC_TRNS,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_TRNS,    KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_TRNS, \
