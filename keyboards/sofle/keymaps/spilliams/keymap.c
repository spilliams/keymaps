 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCtl | LAlt | SYMB | Bspc | /  Del  /       \ Ret  \  | Spc  | SYMB | GUI  | RCtl |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[BASE] = LAYOUT( \
    ...
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MPLY,   KC_MUTE, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
                KC_LCTL,  KC_LALT,  MO(SYMB), KC_BSPC,  KC_DEL,    KC_ENT,   KC_SPC, MO(SYMB), KC_LGUI,  KC_RCTL \
),
/*
 * Symbols
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[SYMB] = LAYOUT( \
    KC_TRNS, KC_NO,  KC_NO,  KC_NO,   KC_NO,    KC_EQL,                   KC_MINS,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO, \
